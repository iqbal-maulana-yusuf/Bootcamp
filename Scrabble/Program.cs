...
// game._currentState = GameState.InProgress;
...
// game.RemovePlayer("maulana");

// ----------------UNIT TEST UNTUK SWAPTILES-------------------------

// var tile1 = game._playerRacks[game._players[0]][0];
// var tile2 = game._playerRacks[game._players[0]][3];
// List<Tile> tileChange = [tile1,tile2];


// Console.WriteLine("player rack");
// foreach (var tile in game._playerRacks[game._players[0]])
// {
//     Console.Write(tile);
// }


// game.SwapTiles(game._players[0], tileChange);
...
// foreach (var item in game.GetAllPlayers())
// {
